CREATE TABLE document_requests (
    ...
    CONSTRAINT fk_docreq_sender FOREIGN KEY (sender_id_keccak) REFERENCES users(user_id_keccak) ON DELETE CASCADE,
    CONSTRAINT fk_docreq_receiver FOREIGN KEY (receiver_id_keccak) REFERENCES users(user_id_keccak) ON DELETE CASCADE,
